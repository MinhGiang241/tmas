                    ...
                    >
                        <Collapse.Panel
                            header={
                                <div className="my-3 flex justify-between items-center">
                                    <div className="flex ">
                                        <span className="body_semibold_14">Câu 1 <span className="body_regular_14">Cho hình bát diện đều ABCDEF. Chứng minh rằng các đoạn thẳng AD, BD và CE đôi một vuông góc với nhau và cắt nhau tại trung điểm mỗi đường thẳng</span></span>
